...
export const bookingReceivedTemplate = (booking: any) => `
${emailHeader}
  <h2 style="color: #3d2314; margin-top: 0;">Booking Received! Thank You</h2>
  <p>Dear ${booking.customerName},</p>
  <p>Thank you for booking with ${companyInfo.name}. We have received your appointment request and are awaiting your visit.</p>

  <div class="info-box">
    <h3 style="color: #3d2314; margin-top: 0;">Request Details</h3>
    <p><strong>Service:</strong> <span class="gold-text">${booking.service}</span></p>
    <p><strong>Date:</strong> ${new Date(booking.date).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
    <p><strong>Time:</strong> ${booking.time}</p>
    <p><strong>Booking ID:</strong> #${booking.bookingId || booking._id}</p>
  ...
  <div style="background: #fff3e0; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #ff9800;">
    ...
    <p style="margin: 10px 0 0 0;">We will review your request and send you a second email once it has been approved.</p>
  </div>

  <p style="margin-top: 30px;">
    If you need to update anything, please reply to this email or call us at ${companyInfo.phone}.
  </p>
${emailFooter}
`;

// Booking Approved Email
export const bookingApprovedTemplate = (booking: any) => `
${emailHeader}
  <h2 style="color: #3d2314; margin-top: 0;">Booking Confirmed! âœ¨</h2>
  <p>Dear ${booking.customerName},</p>
  <p>Your appointment at ${companyInfo.name} has been approved and confirmed. We look forward to seeing you!</p>
  ...
  <div class="info-box">
    ...
    <p><strong>Time:</strong> ${booking.time}</p>
    <p><strong>Duration:</strong> ${booking.duration || '1 hour'}</p>
    <p><strong>Price:</strong> â‚¦${booking.price?.toLocaleString() || 'Contact us'}</p>
    <p><strong>Booking ID:</strong> #${booking.bookingId || booking._id}</p>
  </div>

  <div style="background: #fff3e0; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #ff9800;">
    <p style="margin: 0;"><strong>ðŸ“ Location:</strong><br>
    ${companyInfo.address}<br>
    <a href="https://maps.google.com" style="color: #d4a574;">Get Directions</a></p>
  </div>
