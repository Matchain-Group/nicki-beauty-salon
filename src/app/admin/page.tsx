  ...
  const fetchData = async () => {
    try {
      ...
      if (productsRes.ok) {
        ...
        setProducts(Array.isArray(productData) ? productData : getStaticProducts());
      } else {
    ...
    try {
      ...
      if (editingProductId) {
        setProducts((current) => current.map((product) => (
          product._id === editingProductId ? result : product
        )));
      ...
      setProductMessage(error instanceof Error ? error.message : 'Failed to save product');
    } finally {
          ...
          {activeTab === 'products' && (
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={resetProductForm} className="btn-secondary text-sm">
                  Add New Product
                </button>
              </div>

              <form onSubmit={saveProduct} className="border rounded-xl p-4 mb-6 bg-white">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border rounded-lg px-3 py-2"
                    >
                      {['Hair', 'Skin', 'Lashes', 'Body', 'Nails'].map((category) => (
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full border rounded-lg px-3 py-2"
                      placeholder="/images/hydration-mask.jpg"
                      required
                    />
                    <p className="text-xs text-gray-500 mt-1">Use a file inside `public/images` like `/images/hydration-mask.jpg`.</p>
                  </div>
                ...
                {productMessage && (
                  <p className={`mt-4 text-sm ${productMessage.includes('success') ? 'text-green-600' : 'text-red-600'}`}>
                    {productMessage}
                  </p>
                )}
              ...
              <div className="space-y-4">
                {products.map((product) => {
                  ...
                  return (
                  <div key={productKey} className="flex justify-between items-start border-b pb-4 gap-4">
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className={`text-xs mt-1 ${product.isActive ? 'text-green-600' : 'text-red-600'}`}>
                          {product.isActive ? 'Visible on shop' : 'Hidden on shop'}
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      {productId ? (
                        ...
                        <span className="text-xs text-gray-500">Local preview</span>
                      )}
                    </div>
                  </div>
                  );
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                {portfolioItems.map((item) => {
                  ...
                  return (
                  <div key={itemKey} className="flex justify-between items-center border-b pb-4">
                    <div>
