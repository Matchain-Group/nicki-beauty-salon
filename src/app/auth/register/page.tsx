    ...
    <div className="min-h-screen bg-[#faf7f2] py-12 px-4">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-serif text-[#3d2314] mb-2">Create Account</h1>
          <p className="text-gray-600">Join Nicki Beauty Salon & Spa</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/auth/signin" className="text-[#d4a574] hover:underline font-medium">
                Sign In
              </Link>
            </p>
          </div>
