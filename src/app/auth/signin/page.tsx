      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-[#3d2314] font-medium mb-2">Email Address</label>
            ...
            <div>
              <label className="block text-[#3d2314] font-medium mb-2">Password</label>
              <div className="relative">
...
export default function SignInPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#faf7f2] flex items-center justify-center text-[#3d2314]">
          Loading...
        </div>
      }
    >
