    ...
    <div className="min-h-screen flex items-center 
      ...
      <div className="text-center">
        <div className="animate-spin w-12 h-12 border-4 
          border-[#d4a574] border-t-transparent 
          rounded-full mx-auto mb-4" />
        <p className="text-[#3d2314] text-lg">
  ...
  if (status === 'success') return (
    <div className="min-h-screen flex items-center 
      ...
      <div className="bg-white rounded-2xl p-8 
        max-w-md w-full text-center shadow-lg">
        ...
        <a href="/orders" 
          className="block w-full bg-[#d4a574] 
          text-white py-3 rounded-xl text-center 
          hover:bg-[#b8935f] transition">
          View My Orders
        </a>
        <a href="/shop" 
          className="block w-full mt-3 border 
          border-[#d4a574] text-[#d4a574] 
          py-3 rounded-xl text-center hover:bg-gray-50 
          transition">
          Continue Shopping
        </a>
      </div>
