...
const portfolioItems = getStaticPortfolioItems()
  .filter((item) => item.section === 'Portfolio')
  .map((item, index) => ({
    id: index + 1,
    title: item.title,
    image: item.image,
...
const heroSlides = [
  {
    id: 1,
    image: '/images/premium-beauty-hero.jpg',
    title: 'Premium Beauty Services',
    subtitle: 'Transform Your Look Today',
    alt: 'Elegant black woman receiving a stylish haircut in a modern salon',
  },
  {
    id: 2,
    ...
    <main className="min-h-screen bg-[#faf7f2]">
      ...
      <section className="relative h-[600px] w-full overflow-hidden">
        <Image
          ...
          alt={heroSlides[0].alt ?? heroSlides[0].title}
          fill
          priority
      ...
      {/* CTA SECTION */}
      <section id="contact" className="py-16 px-4 bg-[#3d2314] text-white text-center">
